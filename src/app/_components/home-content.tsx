...
export function HomeContent({ isLoggedIn = false }: HomeContentProps) {
  ...
  // IDs únicos para elementos SVG
  const facebookTitleId = useId();
  const instagramTitleId = useId();
  const twitterTitleId = useId();

  // Features para os planos
  const basicFeatures = [
    { id: "device1", text: "1 Dispositivo" },
    { id: "products100", text: "100 Produtos" },
    { id: "catalog", text: "Catálogo Digital" },
    { id: "reports", text: "Relatórios Básicos" },
  ];

  const proFeatures = [
    { id: "device3", text: "3 Dispositivos" },
    { id: "products500", text: "500 Produtos" },
    { id: "catalogCustom", text: "Catálogo Personalizado" },
    { id: "reportsAdvanced", text: "Relatórios Avançados" },
    { id: "support", text: "Suporte Prioritário" },
    { id: "api", text: "API de Integração" },
  ];
  ...
  const catalogServices = [
    { id: "service1", name: "Serviço 1", duration: 30, price: 59.90 },
    { id: "service2", name: "Serviço 2", duration: 45, price: 119.80 },
    { id: "service3", name: "Serviço 3", duration: 60, price: 179.70 },
    { id: "service4", name: "Serviço 4", duration: 75, price: 239.60 },
  ];
                      ...
                      {catalogServices.map((service) => (
                        <div className="col-6" key={service.id}>
                          <div className="card card-status-primary p-3 h-100">
                            ...
                            <div className="small fw-medium">{service.name}</div>
                            <div className="small text-secondary">
        ...
        <div className="container">
          <div className="row g-4">
            <div className="col-lg-4">
              ...
              <div className="d-flex gap-3">
                <a href="https://facebook.com" aria-label="Facebook" className="text-white opacity-75 hover-scale">
                  ...
                  >
                    <title id={facebookTitleId}>Facebook</title>
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                  </svg>
                </a>
                <a href="https://instagram.com" aria-label="Instagram" className="text-white opacity-75 hover-scale">
                  ...
                  <svg
                    ...
                    viewBox="0 0 16 16"
                    role="img"
                    aria-labelledby={instagramTitleId}
                  >
                ...
                <a href="https://twitter.com" aria-label="Twitter" className="text-white opacity-75 hover-scale">
